...
public class GameManager : MonoBehaviour {
    ...
    public string restartLevelLevelToLoad;
	...
	void EndGame() {
        ...
        // activate the restartLevelButtons gameObject, if it is set
        if (restartLevelButtons)
	...
	public void RestartGame ()
	{
		...
		UnityEngine.SceneManagement.SceneManager.LoadScene(restartGameLevelToLoad);
	}
    ...
    public void RestartLevel()
    {
        // we are just loading a scene (or reloading this scene)
        // which is an easy way to restart the level
        UnityEngine.SceneManagement.SceneManager.LoadScene(restartLevelLevelToLoad);
    }
